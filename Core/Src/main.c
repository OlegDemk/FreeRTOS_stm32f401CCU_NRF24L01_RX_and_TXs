...
extern uint8_t TX_ADDRESS_0[3];
extern uint8_t TX_ADDRESS_1[3];
extern uint8_t TX_ADDRESS_2[1];
extern uint8_t TX_ADDRESS_3[1];
extern uint8_t TX_ADDRESS_4[1];
extern uint8_t TX_ADDRESS_5[1];
...
//uint8_t debug_address[3] = {0x11,0x12,0x13};
...
//	NRF24_init_RX(1,1,1,1,1,1,
//			76,  nRF24_DR_2Mbps, nRF24_TXPWR_0dBm);				// Налаштування: які канали відкрити, частота передачі,


	/* @param
		1. - number of pipe		   			( from 0 to 6 )
